...
export const Icons = {
  ...
  LogoSmall: (props: any) => (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M19.0064 10.9998H26.5064C26.6246 10.9998 26.7408 11.008 26.8546 11.0238L19.0248 18.8536C19.0085 18.738 19 18.6199 19 18.4998V10.9998H16V22.357C16 23.875 17.4766 24.5156 18.591 23.4777L21.1462 20.975L31.4375 10.6484C32.4141 9.625 32.1484 7.99976 30.3516 7.99976H19.0064V10.9998ZM0 9.99976V10.0079L10.2505 23.0612C11.4824 24.63 14.0021 23.7588 14.0021 21.7642V9.99976H11.0021V19.1609L3.80808 9.99976H0Z"
        fill="currentColor"
      />
    </svg>
  ),
  LogoIcon: (props: any) => (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M9.50321 5.49988H13.2532C13.3123 5.49988 13.3704 5.50398 13.4273 5.51191L9.51242 9.4268C9.50424 9.369 9.5 9.30994 9.5 9.24988V5.49988H8V11.1785C8 11.9375 8.73828 12.2578 9.29549 11.7388L10.5731 10.4875L15.7188 5.32422C16.207 4.8125 16.0742 3.99988 15.1758 3.99988H9.50321V5.49988ZM0 4.99988V5.00393L5.12525 11.5306C5.74119 12.315 7.00106 11.8794 7.00106 10.8821V4.99988H5.50106V9.58044L1.90404 4.99988H0Z"
        fill="currentColor"
      />
    </svg>
  ),
  Logo: (props: any) => (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#clip0_122_123)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M17.069 9.62482H23.6315C23.735 9.62482 23.8366 9.63192 23.9362 9.64582L17.0851 16.4969C17.0709 16.3958 17.0634 16.2924 17.0634 16.1873V9.62482H14.4384V19.5624C14.4384 20.8906 15.7304 21.4512 16.7056 20.543L18.9414 18.3531L27.9462 9.31738C28.8007 8.42188 28.5683 6.99979 26.996 6.99979H17.069V9.62482ZM0.438416 8.74979V8.75687L9.40763 20.1785C10.4855 21.5512 12.6903 20.7889 12.6903 19.0437V8.74979H10.0653V16.7658L3.77048 8.74979H0.438416Z"
          fill="currentColor"
        />
        <path
          d="M47.6091 10.5045H45.7477L42.5211 19.6466L39.2945 10.5045H37.433L41.4249 21.4667H43.6173L47.6091 10.5045Z"
          fill="currentColor"
        />
        <path
          d="M54.1099 21.4667C57.1503 21.4667 59.1152 19.2122 59.1152 15.7374C59.1152 12.2626 57.1503 10.0081 54.1099 10.0081C51.0694 10.0081 49.1045 12.2626 49.1045 15.7374C49.1045 19.2122 51.0694 21.4667 54.1099 21.4667ZM50.9246 15.7374C50.9246 13.1933 52.0829 11.6627 54.1099 11.6627C56.1368 11.6627 57.2951 13.1933 57.2951 15.7374C57.2951 18.2815 56.1368 19.8119 54.1099 19.8119C52.0829 19.8119 50.9246 18.2815 50.9246 15.7374Z"
          fill="currentColor"
        />
        <path
          d="M66.6912 10.5045H61.0239V12.035H64.9538V19.9361H60.6103V21.4667H70.4348V19.9361H66.6912V10.5045ZM64.7263 8.87054H66.6912V6.78152H64.7263V8.87054Z"
          fill="currentColor"
        />
        <path
          d="M81.6512 6.53333H79.9138V11.7042C79.2933 10.6079 78.1764 10.0081 76.5424 10.0081C73.3779 10.0081 71.93 12.7176 71.93 15.7374C71.93 18.7571 73.3779 21.4667 76.5424 21.4667C78.2384 21.4667 79.4174 20.7841 80.0172 19.6466L80.0793 21.2185H81.6512V6.53333ZM73.7502 15.7374C73.7502 13.5656 74.6396 11.58 76.9147 11.58C79.1692 11.58 80.0793 13.607 80.0793 15.7374C80.0793 17.785 79.1692 19.812 76.9147 19.812C74.6396 19.812 73.7502 17.8264 73.7502 15.7374Z"
          fill="currentColor"
        />
        <path
          d="M87.3244 10.5045H83.1464V12.0351H86.0007V19.9361H83.1464V21.4667H91.3163V19.9361H87.7381V14.9307C87.7381 13.0486 88.5241 12.0351 90.1994 12.0351H92.3918V10.5045H90.1994C88.7515 10.5045 87.8621 11.1664 87.4692 12.5728L87.3244 10.5045Z"
          fill="currentColor"
        />
        <path
          d="M93.8868 15.7374C93.8868 19.2122 95.872 21.4667 98.9128 21.4667C101.022 21.4667 102.864 20.1843 103.505 18.116L101.643 17.9711C101.146 19.1294 100.092 19.8119 98.9128 19.8119C97.0303 19.8119 95.8935 18.5089 95.7479 16.2752H103.691L103.67 15.4892C103.483 11.6008 101.333 10.0081 98.9128 10.0081C95.872 10.0081 93.8868 12.2626 93.8868 15.7374ZM95.7693 14.7446C96.0587 12.8004 97.1749 11.6627 98.9128 11.6627C100.257 11.6627 101.478 12.4487 101.787 14.7446H95.7693Z"
          fill="currentColor"
        />
        <path
          d="M105.372 13.4829L107.233 13.6277C107.502 12.4901 108.495 11.6627 109.861 11.6627C111.474 11.6627 112.508 12.5521 112.528 14.4136L109.323 15.0548C106.903 15.5098 105.186 16.089 105.186 18.3434C105.186 20.3084 106.965 21.4667 109.137 21.4667C110.874 21.4667 112.115 20.5359 112.55 19.5224C112.735 20.5152 113.521 21.2185 114.845 21.2185H115.383V19.6879H114.948C114.473 19.6879 114.266 19.4604 114.266 19.0054V14.5998C114.266 11.5387 112.508 10.0081 109.861 10.0081C107.585 10.0081 105.786 11.4146 105.372 13.4829ZM107.007 18.3434C107.007 16.8129 108.351 16.7095 109.985 16.4199L112.57 15.9649V16.5026C112.57 18.6744 111.164 19.9154 109.364 19.9361C107.751 19.9361 107.007 19.2122 107.007 18.3434Z"
          fill="currentColor"
        />
        <path
          d="M116.878 10.5045V21.4667H118.636V14.8894C118.636 12.9038 119.153 11.7869 120.001 11.7869C120.953 11.7869 121.304 12.6763 121.304 14.8894V21.4667H123.041V14.8894C123.041 12.9038 123.6 11.7869 124.551 11.7869C125.4 11.7869 125.73 12.6556 125.73 14.8894V21.4667H127.468V14.8894C127.468 11.6628 126.744 10.2563 125.069 10.2563C123.931 10.2563 123.041 11.0423 122.648 12.304C122.318 10.8768 121.738 10.2563 120.787 10.2563C119.691 10.2563 118.946 10.8768 118.532 12.0144L118.471 10.5045H116.878Z"
          fill="currentColor"
        />
      </g>
      <defs>
        <clipPath id="clip0_122_123">
          <rect width="127.867" height="28" fill="white" />
        </clipPath>
      </defs>
    </svg>
  ),
