          ...
          <div className="p-12 relative">
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-sm text-secondary">
                ...
                <span>{t("free.features.video_quality")}</span>
              </li>
              <li className="flex items-center gap-2 text-sm text-secondary">
                <MdCheck className="w-4 h-4 text-primary" />
                <span>{t("free.features.basic_voice")}</span>
              </li>
              <li className="flex items-center gap-2 text-sm text-secondary">
                <MdCheck className="w-4 h-4 text-primary" />
                <span>{t("free.features.basic_template")}</span>
              </li>
              <li className="flex items-center gap-2 text-sm text-secondary">
                <MdCheck className="w-4 h-4 text-primary" />
                <span>{t("free.features.with_watermark")}</span>
              </li>
              <li className="flex items-center gap-2 text-sm text-secondary">
                <MdCheck className="w-4 h-4 text-primary" />
                <span>{t("free.features.subtitle")}</span>
              </li>
              <li className="flex items-center gap-2 text-sm text-secondary">
                <MdCheck className="w-4 h-4 text-primary" />
                <span>{t("free.features.basic_bgm")}</span>
              </li>
            </ul>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-border border-t border-border">
          <div className="p-12 pt-10 relative min-h-[300px]">
            <div className="flex flex-col gap-2">
              <span className="text-sm">{t("free.points")}</span>
          ...
          <div className="p-12 pt-28">
            ...
            <div className="mt-4">
              <Link href={`/login?plan=pro&tier=${value[0]}`}>
                <OutlinedButton>{t("pro.cta")}</OutlinedButton>
              </Link>
            </div>
          </div>
        </div>
