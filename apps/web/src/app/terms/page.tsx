    ...
    <>
      <div className="prose dark:prose-invert container py-12">
        ...
        <p>
          ...
          your relationship with Midday application (the "Service") operated by
          Midday Labs AB ("us", "we", or "our").
        </p>
        ...
        <p>
          ...
          renew under the exact same conditions unless you cancel it or Midday
          Labs AB cancels it. You may cancel your Subscription renewal either
          through your online account management page or by contacting Midday
          Labs AB customer support team.
        </p>

        <p>
          A valid payment method, including credit card, is required to process
          the payment for your Subscription. You shall provide Midday Labs AB
          ...
          authorize Midday Labs AB to charge all Subscription fees incurred
          through your account to any such payment instruments.
        </p>

        <p>
          Should automatic billing fail to occur for any reason, Midday Labs AB
        ...
        <p>
          Midday Labs AB, in its sole discretion and at any time, may modify the
        ...
        <p>
          Midday Labs AB will provide you with a reasonable prior notice of any
        ...
        <p>
          Certain refund requests for Subscriptions may be considered by Midday
        ...
        <p>
          ...
          "Copyright Infringement" of dmca@midday.ai and include in your notice
        ...
        <p>
          ...
          property of Midday Labs AB and its licensors. The Service is protected
          by copyright, trademark, and other laws of both the Sweden and foreign
          countries. Our trademarks and trade dress may not be used in
          connection with any product or service without the prior written
          consent of Midday Labs AB.
        </p>
        ...
        <p>
          Midday Labs AB has no control over, and assumes no responsibility for,
          the content, privacy policies, or practices of any third party web
          sites or services. You further acknowledge and agree that Midday Labs
          AB shall not be responsible or liable, directly or indirectly, for any
        ...
        <p>
          Midday Labs AB its subsidiaries, affiliates, and its licensors do not
