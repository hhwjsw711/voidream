...
export default function PrivacyPolicyPage() {
  return (
    <div className="prose container py-12">
      ...
      <p>
        Voidream (&apos;we&apos;, &apos;us&apos;, or &apos;our&apos;) provides
        ...
        may receive from users of our website (&apos;Site&apos;), accessible
        from https://voidream.com, and any other services offered by us in
        connection with our site (any and all of the foregoing the
        &apos;Services&apos;).
      </p>
      <p>
        If you have additional questions or require more information about our
        Privacy Policy, do not hesitate to contact us at hhwjsw711@gmail.com.
        This Privacy Policy applies only to our online activities and is valid
        for visitors to our website with regards to the information that they
        shared and/or collect in Voidream. This policy is not applicable to any
