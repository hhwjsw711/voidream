  ...
  return (
    <>
      <div className="prose dark:prose-invert container py-12">
        ...
        <p>
          Midday Labs AB ("us", "we", or "our") operates the Midday application
        ...
        <ul>
          <li>
            ...
            <p>Service is the Midday application operated by Midday Labs AB</p>
          </li>
          <li>
            <p>
        ...
        <h2>Use of Data</h2>
        <p>Midday Labs AB uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          We do not use any data obtained from Google Workspace APIs — including
          Gmail data — to develop, improve, or train generalized artificial
        ...
        <p>
          If you are from the European Economic Area (EEA), Midday Labs AB legal
        ...
        <p>Midday Labs AB may process your Personal Data because:</p>
        <ul>
        ...
        <p>
          If you are located outside Sweden and choose to provide information to
          us, please note that we transfer the data, including Personal Data, to
          Sweden and process it there.
        </p>
        <p>
        ...
        <p>
          If Midday Labs AB is involved in a merger, acquisition or asset sale,
        ...
        <p>
          ...
          certain data protection rights. Midday Labs AB aims to take reasonable
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              right to withdraw your consent at any time where Midday Labs AB
